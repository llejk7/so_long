...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/11 14:42:19 by krenken           #+#    #+#             */
/*   Updated: 2024/07/22 18:01:54 by krenken          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	char str1[11];
	const char *str2 = "gucken wir mal";

	size_t result = ft_strlcpy(str1, str2, sizeof(str1));
	printf("%zu\n", result);
	printf("%s", str1);
}*/